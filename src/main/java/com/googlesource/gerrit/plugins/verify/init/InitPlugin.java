...
package com.googlesource.gerrit.plugins.verify.init;
...
import com.googlesource.gerrit.plugins.verify.server.CiDb;
import com.googlesource.gerrit.plugins.verify.server.schema.CiDataSourceModule;
import com.googlesource.gerrit.plugins.verify.server.schema.CiDataSourceProvider;
import com.googlesource.gerrit.plugins.verify.server.schema.CiDataSourceType;
import com.googlesource.gerrit.plugins.verify.server.schema.CiDataSourceTypeGuesser;
import com.googlesource.gerrit.plugins.verify.server.schema.CiDatabaseModule;
import com.googlesource.gerrit.plugins.verify.server.schema.SchemaVersion;
import com.googlesource.gerrit.plugins.verify.server.schema.UpdateUI;
