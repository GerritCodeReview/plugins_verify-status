...
/**
 * Pop down button on the change info panel in change screen.
 */
public class JobsPanelButton extends PopDownButton {

  public JobsPanelButton(String text, Widget widget) {
    super(text, widget);
  }
  ...
  protected void show() {
    ...
    final PopupPanel p = new PopupPanel(true) {
      ...
      public void setPopupPosition(int left, int top) {
        top = relativeTo.getAbsoluteTop() + relativeTo.getOffsetHeight();
